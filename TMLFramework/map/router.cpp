...
Router::Router(Map *map, int seed,int startpoint, int endpoint):
    map(map)
{
    this->rng = std::mt19937(seed);
...
{   
    ...
    //tried to use the this->startpoint and this->endpoint but the program crashes after
    //click on Button "Create Route"
   ...
   //end = 18336;
    ...
    /**Problem wenn Start und Endwert nicht gesetzt werden
    start = this->startpoint;
    end = this->endpoint;**/  
      
   std::cout<<"Coordinates" << start << " " << end;
