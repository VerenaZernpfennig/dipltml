...
QT_MOC_LITERAL(6, 95, 11), // "QModelIndex"
QT_MOC_LITERAL(7, 107, 5), // "index"
QT_MOC_LITERAL(8, 113, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(9, 135, 21) // "on_buttonBox_rejected"

    },
    "POIFilterChooser\0onClose\0\0"
    "std::map<std::string,std::set<std::string> >\0"
    "selection\0onTreeClicked\0QModelIndex\0"
...
void POIFilterChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (POIFilterChooser::*)(std::map<std::string,std::set<std::string>> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&POIFilterChooser::onClose)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject POIFilterChooser::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_POIFilterChooser.data,
      qt_meta_data_POIFilterChooser,  qt_static_metacall, nullptr, nullptr}
};
