...
public:
  ...
  ILPAdapter(Map *map, VisibilityIntervals &visibilityIntervals, ConflictIntervals &conflicts, Heuristic::ModelType mtype, int k = -1, int deviation = 1, const char *dbg_filename = nullptr);
  void run();
